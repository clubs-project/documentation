...
\end{tabular}
% 
% #       -train_src $data/$train$src -train_tgt $data/$train$tgt -valid_src  $data/$val$src\
% #       -valid_tgt $data/$val$tgt -save_data $data -src_vocab_size 150000  -tgt_vocab_size 150000  -dynamic_dict\
% #       -save_model $seq2seq -gpuid  0 1 2 3 4 5 6 7  \
% #       -rnn_size 1024 -word_vec_size 512  -dropout 0.2 -optim adam -learning_rate 0.0001\
% #       -batch_size 30 -rnn_type GRU -report_every 100 -share_embeddings -train_steps 20000000 \
% #       -share_vocab  
...
%     --mini-batch-fit -w 7500 --mini-batch 5000 --maxi-batch 5000 --maxi-batch-sort src \
%     --early-stopping 10 \
%     --valid-freq 5000 --save-freq 5000 --disp-freq 512 \
%     --valid-metrics cross-entropy perplexity translation \
%     --valid-sets $tests/$valid.$L1 $tests/$valid.$L2 \
%     --valid-script-path $root/validate.sh \
%     --valid-translation-output $data/valid.$modelName.bpe.de.output --quiet-translation \
%     --valid-mini-batch 32 \
%     --beam-size 6 --normalize 0.6 \
%     --log model/train.$modelName.log --valid-log model/valid.$modelName.log \
...
%     --optimizer-params 0.9 0.998 1e-09 --clip-norm 5 \
%     --tied-embeddings-all \
