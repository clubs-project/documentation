...
\begin{document}
	...
	\begin{table}[h]
		...
		\begin{tabular}{llrrrr}
			...
			&DFK    &  198,456 (35.4\%)  & 362,399 (64.6\%)  &   719,892 (81.0\%)  & 169,154 (19.0\%)  \\
			&PMID   &  585,430 (74.3\%)  & 202,969 (25.7\%)  & 1.197,228 (99.3\%)  &   7,886 (0.7\%) \\
			\midrule
			\multirow{2}{*}{\begin{sideways}Q\end{sideways}} 
			&DFK    &  348,343 (53.3\%)  & 304,793 (46.7\%)  & 1,032,638 (99.7\%)  & 2,613 (0.3\%) \\
		...
		\begin{tabular}{llrrrr}
			...
			\midrule
			\multirow{2}{*}{\begin{sideways}M\end{sideways}} 
			&DFK    &  169,522 (30.0\%)  & 395,236 (70.0\%)  &   483,674 (66.5\%)  & 243,932 (33.5\%) \\
			&PMID   &  587,289 (73.6\%)  & 210,611 (26.4\%)  & 1,070,023 (99.0\%)  &  10,879 (1.0\%) \\
			\midrule
			\multirow{2}{*}{\begin{sideways}Q\end{sideways}} 
			&DFK    &  375,436 (57.1\%)  & 282,199 (42.9\%)  &  846,825 (99.9\%)  & 901 (0.1\%)    \\
		...
		\begin{tabular}{llrrrr}
			...
			\midrule
			\multirow{1}{*}{\begin{sideways}M\end{sideways}} 
			&PMID~~~~&  545,436 (70.1\%)  & 232,138 (29.9\%)  & 1,327,668 (97.6\%)  & 32,301 (2.4\%) \\
			\midrule
			\multirow{-1}{*}{\begin{sideways}Q\end{sideways}} 
			&PMID    &  557,964 (71.8\%)  & 219,610 (28.2\%)  & 1,353,105 (99.5\%)  & 6,864 (0.5\%) \\
			\bottomrule
		\end{tabular}
	...
	\begin{table}[h]
		...
		\begin{tabular}{llrrrr}
			...
			&Source & \mc{1}{c}{trad (\%)} & \mc{1}{c}{untrad (\%)} &\mc{1}{c}{trad (\%)} & \mc{1}{c}{untrad (\%)} \\
			\midrule
			\multirow{4}{*}{\begin{sideways}M\end{sideways}} 
			&DFK    &   1,226 (9.0\%)   &  12,400 (91.0\%)  &  14,535 (73.2\%)  &   5,325 (26.8\%)  \\
			...
			\midrule
			\multirow{4}{*}{\begin{sideways}Q\end{sideways}} 
			&DFK    &   2,647 (19.4\%)  &  10,979 (80.6\%)  &  18,359 (92.4\%)  &  1,501 (7.6\%)   \\
		...
		\begin{tabular}{llrrrr}
			...
			\midrule
			\multirow{1}{*}{\begin{sideways}M\end{sideways}} 
			&DFK    &  909 (6.7\%)  & 12,645 (93.3\%)  & 9,139 (58.9\%)  & 6,386 (41.1\%)  \\
			\midrule
			\multirow{1}{*}{\begin{sideways}Q\end{sideways}} 
			&DFK    &  2,575 (19.0\%)  & 10,979 (81.0\%)  & 12,236 (78.8\%)  & 3,289 (21.2\%)  \\
			\bottomrule
		\end{tabular}		
	...
	\begin{table}[h]
		...
		\begin{tabular}{llrrrr}
			...
			\midrule
			\multirow{4}{*}{\begin{sideways}M\end{sideways}} 
			&DFK    &  427 (10.3\%)  & 3733 (89.7\%)  & 4181 (71.5\%)  & 1664 (28.5\%)   \\
			...
			\midrule
			\multirow{4}{*}{\begin{sideways}Q\end{sideways}} 
			&DFK    &  870 (20.9\%)  & 3290 (79.1\%)  & 5439 (93.1\%)  & 406 (6.9\%)  \\
		...
		\begin{tabular}{llrrrr}
			...
			\midrule
			\multirow{2}{*}{\begin{sideways}M\end{sideways}} 
			&DFK    &  192 (4.7\%)  & 3,851 (95.3\%)  & 2,569 (56.0\%)  & 2,015 (44.0\%) \\
			&INIST  &    0 (0\%)  & 0 (0\%)  & 0 (0\%)  & 0 (0\%) \\
			\midrule
			\multirow{2}{*}{\begin{sideways}Q\end{sideways}} 
			&DFK    &  698 (17.3\%)  & 3,345 (82.7\%)  & 3,512 (76.6\%)  & 1,072 (23.4\%)   \\
		...
		\begin{tabular}{llrrrr}
			...
			\midrule
			\multirow{1}{*}{\begin{sideways}M\end{sideways}} 
			&INIST  & 583,688 (40.9\%)  & 844,195 (59.1\%)  & 1,569,921 (71.5\%)  & 626,879 (28.5\%) \\
			\midrule
			\multirow{1}{*}{\begin{sideways}Q\end{sideways}} 
			&INIST  &  891,522 (55.6\%)  & 710,891 (44.4\%)  & 2,237,974 (90.8\%)  & 225,493 (9.2\%) \\
			\bottomrule
		\end{tabular}
		...
		\begin{tabular}{llrrrr}
			...
			\midrule
			\multirow{2}{*}{\begin{sideways}M\end{sideways}} 
			&INIST  & 442,354 (32.7\%)  & 910,874 (67.3\%)  & 1,366,275 (67.2\%)  & 667,708 (32.8\%)  \\
			&ISOC   &  73,362 (27.4\%)  & 194,717 (72.6\%)  &   294,892 (70.5\%)  & 123,488 (29.5\%) \\
			\midrule
			\multirow{2}{*}{\begin{sideways}Q\end{sideways}} 
			&INIST  & 736,027 (48.4\%)  & 783,455 (51.6\%)  & 2,082,259 (91.2\%)  & 201,189 (8.8\%)  \\
